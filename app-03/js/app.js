...
// //     licenseNumber: 12345,
// //     sayHi: () => {
// //         console.log("Hi, my name is Isiah");
// //     }
// // }
...
//                         divide: (a, b) => {
//                             const division = a/b;
//                             const value = division.toFixed(1);
//                             return value;
//                         }
//                     },
//                    {
...
//                        divide :(a, b) => {
//                         const division = a/b
//                         const value = division.toFixed(2);
//                         return value;
//                         }
//                     }
//                 ]
...
// console.log(calculator.otherOperations.version.two.decimalPlaces[0].divide(10,2));
...
// const arr = ["Luis","Hannah","John","Smith"]
// console.log(arr)
// for (let i = 0; i < arr.length; i++){
//     console.log(i, arr[i]);
...
// const arr2 = [1,0,3,2]
// console.log (arr2)
// const arr3 = [4,5,6,7,7]
// console.log (arr3, "Tom runs+Tabitha skips",arr3[2])
...
// console.log(nameObj)
// console.log(nameObj.fName1)
// console.log(nameObj["fName1"])
// nameObj.hello()

// const arr = [1,2,3,"Hello", false, nameObj];
